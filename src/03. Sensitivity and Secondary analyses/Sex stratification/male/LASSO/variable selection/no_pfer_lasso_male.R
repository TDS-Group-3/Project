...
mydata <- readRDS("/rds/general/project/hda_21-22/live/TDS/Group_3/final_data/secondary_analysis_sex/complete_data_male_variable_selection_dummy.rds")
...
saveRDS(selprop, file = "no_pfer_male_LASSO_selection_proportions.rds")
...
saveRDS(LASSO_parameters, file = "no_pfer_male_LASSO_parameters.rds")
...
saveRDS(LASSO_selected_variables, file = "no_pfer_male_LASSO_selected_variables.rds")